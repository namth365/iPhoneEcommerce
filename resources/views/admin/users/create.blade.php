                    ...
                    <div class="card-body card-block">
                        <form action=" {{route('users.store')}} " method="post" class="form-horizontal"
                                    ...
                                    <div class="form-check">
                                        ...
                                        <div class="radio">
                                            <label for="radio2" class="form-check-label ">
                                                <input type="radio" id="radio2" name="gender" value="fe-male"
                                                    class="form-check-input">Fe-Male
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-check col col-md-2">
                                        ...
                                        <div class="checkbox">
                                            <label for="checkbox1" class="form-check-label ">
                                                <input type="checkbox" id="checkbox1" name="role_ids[]"
                            ...
                            <div class="col col-md-2">
                                ...
                                <a href="{{route('users.index')}}" type="reset" class="btn btn-danger btn-sm"
