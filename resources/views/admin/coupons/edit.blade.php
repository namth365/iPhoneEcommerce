                        ...
                        <form action=" {{route('coupons.update', $coupon->id)}} " method="post"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input"
                                        value="{{old('name') ?? $coupon->name}}" name="name" class="form-control">
                                    @error('name')
                            ...
                            <div class="row form-group">
                                <div class="col col-md-2"><label for="text-input"
                                        class=" form-control-label">Value</label></div>
                                <div class="col-12 col-md-9"><input type="number" id="text-input"
                                        value="{{old('value') ?? $coupon->value}}" name="value"
                                        class="form-control">
                                    @error('value')
                                    <span class="text-danger"> {{$message}} </span>
                                    @enderror
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="type" id="select" class="form-control">
                                        ...
                                        <option value="money" {{ (old('type') ?? $coupon->type) == 'money' ?
                                            'selected' : '' }} > Money </option>
                                        <option value="cash" {{ (old('type') ?? $coupon->type) == 'cash' ?
                            ...
                            <div class="row form-group">
                                <div class="col col-md-2"><label for="text-input" class=" form-control-label">Expery
                                        Date</label></div>
                                <div class="col-12 col-md-9"><input type="date" id="text-input"
                                        value="{{old('expery_date')  ?? $coupon->expery_date}}" name="expery_date"
                                        class="form-control">
                                    @error('expery_date')
                                    <span class="text-danger"> {{$message}} </span>
                                    @enderror
                            ...
                            <div class="col col-md-2">
                                ...
                                <a href="{{route('coupons.index')}}" type="back" class="btn btn-danger btn-sm"
